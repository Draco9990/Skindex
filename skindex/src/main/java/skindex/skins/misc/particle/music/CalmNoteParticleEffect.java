...
public class CalmNoteParticleEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vX;
    private float vY;
    ...
    public CalmNoteParticleEffect(AbstractCreature target) {
        ...
        this.x = target.hb.cX + MathUtils.random(100.0F, 160.0F) * Settings.scale - 32.0F;
        this.y = target.hb.cY + MathUtils.random(-50.0F, 220.0F) * Settings.scale - 32.0F;
