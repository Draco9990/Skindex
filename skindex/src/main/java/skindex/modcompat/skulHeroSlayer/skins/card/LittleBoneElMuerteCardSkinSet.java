...
public class LittleBoneElMuerteCardSkinSet {
    ...
    public static class Attack extends CardSkinData{
        public static String ID = "LITTLE_BONE_ELMUERTE_ATTACK";
        public Attack(){
            id = ID;
            name = "El Muerte";
            ...
            cardBg = "skindexResources/images/skins/player/littlebone/elmuerte/attackCardBg.png";
        }
    }

    public static class Skill extends CardSkinData{
        public static String ID = "LITTLE_BONE_ELMUERTE_SKILL";
        public Skill(){
            id = ID;
            name = "El Muerte";
            ...
            cardBg = "skindexResources/images/skins/player/littlebone/elmuerte/skillCardBg.png";
        }
    }

    public static class Power extends CardSkinData{
        public static String ID = "LITTLE_BONE_ELMUERTE_POWER";
        public Power(){
            id = ID;
            name = "El Muerte";
            ...
            cardBg = "skindexResources/images/skins/player/littlebone/elmuerte/powerCardBg.png";
        }
    }
}
